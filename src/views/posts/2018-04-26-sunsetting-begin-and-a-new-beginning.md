...
Here’s what happens next: if you’re a Begin user, you’ll have until May 9th, 2018, to download your tasks ([head here to grab them](https://begin.com/account/tasks)). After that, we’ll be shutting down our Slack, web, and Mac apps.

We care deeply about your privacy, which is why we’ll also be destroying all user data after shutting down the product — so please do make sure you [grab your task list](https://begin.com/account/tasks).

## Now onto the good news: we’re working on [something new](https://fun.begin.com/)!

In the course of creating Begin, we built some pretty unique new cloud function infrastructure tooling, which we open sourced last year in partnership with the [JavaScript Foundation](https://js.foundation/) as [JSF Architect](https://arc.codes/).
...
Want to check it out? The first beta is coming in a few weeks. [Head here to get on the list!](https://fun.begin.com/)
